  ...
  return (
    <div className="gd-rise space-y-5 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base sm:text-lg font-extrabold text-white">Live Tracking</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
        ...
        <div className="lg:col-span-7 relative rounded-3xl bg-slate-900 border border-slate-800 h-80 sm:h-96 overflow-hidden shadow-2xl flex flex-col justify-between p-4">
        ...
        <div className="lg:col-span-5 p-5 rounded-3xl bg-slate-900 border border-slate-800 space-y-4">
          ...
          <div className="flex items-center justify-between p-3 rounded-2xl bg-slate-800/80 border border-slate-700/60">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-white shadow-md shadow-cyan-950 transition-all cursor-pointer"
