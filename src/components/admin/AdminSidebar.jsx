...
export default function AdminSidebar({
  ...
  const renderSidebar = (isExpanded) => (
    <div className="flex flex-col h-full bg-slate-900 text-slate-100 select-none">
      ...
      >
        <div className="w-10 h-10 rounded-xl bg-cyan-600 flex items-center justify-center shadow-lg shadow-cyan-950/60 flex-shrink-0">
        ...
        {isExpanded && (
          <div className="min-w-0 flex-1 animate-in fade-in duration-200">
            ...
            <div className="text-[9px] font-mono text-cyan-400 uppercase tracking-widest flex items-center gap-1 font-bold truncate">
              <Sparkles size={10} /> Platform Admin
            </div>
          </div>
        )}
        {isExpanded && (
              ...
              {group.items.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {badge && isExpanded && (
                      <span className="ml-auto text-[10px] font-bold px-1.5 py-0.5 rounded-full bg-cyan-500 text-slate-950 min-w-[18px] text-center">
                        {badge > 99 ? "99+" : badge}
                      </span>
                    )}
                    {badge && !isExpanded && (
