    ...
    <div className="space-y-6 gd-rise w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {pendingRiders.length === 0 ? (
          <div className="p-10 rounded-3xl bg-slate-900 border border-slate-800 text-center space-y-3 col-span-full shadow-lg">
            ...
            <h3 className="text-base font-extrabold text-white">All KYC Applications Reviewed</h3>
            <p className="text-xs text-slate-400 max-w-sm mx-auto">
              There are currently no pending delivery partner onboarding applications in the verification queue.
            </p>
          </div>
        ) : (
          pendingRiders.map((rider) => (
            <div
              key={rider.id}
              className="p-5 rounded-3xl bg-slate-900 border border-slate-800 space-y-4 shadow-md flex flex-col justify-between hover:border-slate-700 transition-all"
            >
              ...
              <div className="pt-3 border-t border-slate-800 flex items-center justify-end gap-2">
                <button
                  ...
                  onClick={() => {
                    ...
                    setReason("Incomplete or invalid documents submitted.");
                  }}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    setReason("Background check & Driving License verified.");
                  }}
