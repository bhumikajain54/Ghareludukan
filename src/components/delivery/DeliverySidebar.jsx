  ...
  const navGroups = [
    {
      ...
      items: [
        ...
        { id: "jobs", label: "Delivery Pool & Active", icon: Bike, badge: availableJobs },
      ],
    },
    {
      ...
      items: [
        ...
        { id: "performance", label: "Ratings & Badges", icon: Award },
      ],
    },
    {
      group: "ACCOUNT & SETTINGS",
      items: [
        { id: "notifications", label: "Alerts & Updates", icon: Bell, badge: unreadNotifs },
        { id: "profile", label: "Rider Profile & KYC", icon: User },
        { id: "settings", label: "Rider Settings", icon: Settings },
        { id: "support", label: "Emergency & Support", icon: Headphones },
      ],
    },
  ];
      ...
      <div className="flex items-center px-4 py-3.5 border-b border-slate-800 h-16 shrink-0 overflow-hidden">
        ...
        >
          ...
          <div className="text-[9px] font-mono text-cyan-400 uppercase tracking-widest flex items-center gap-1 font-bold truncate">
            <Sparkles size={9} /> Delivery Portal
          </div>
        </div>
...
export function DeliveryBottomNav({ view, onNav, availableJobs = 0 }) {
  const items = [
    { id: "dashboard", label: "Duty", Icon: Home },
    { id: "jobs", label: "Jobs", Icon: Bike, badge: availableJobs },
    { id: "earnings", label: "Earnings", Icon: Wallet },
    { id: "profile", label: "Profile", Icon: User },
    { id: "support", label: "Help", Icon: Headphones },
  ];
